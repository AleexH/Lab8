...
namespace OpenTK_winforms_z02
{
    public partial class Form1 : Form
    {
        ...
        private void GlControl1_Paint(object sender, PaintEventArgs e) {
            ...
            valuesDiffuse1[0] = 0.4f;
            valuesDiffuse1[1] = 0.4f;
            valuesDiffuse1[2] = 0.4f;

            valuesSpecular1[0] = 0.1f;
            valuesSpecular1[1] = 0.1f;
            valuesSpecular1[2] = 0.1f;

            valuesPosition1[0] = 10;
            valuesPosition1[1] = 10;
            valuesPosition1[2] = 10;
